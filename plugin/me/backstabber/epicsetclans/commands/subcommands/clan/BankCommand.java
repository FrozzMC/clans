...
public class BankCommand extends SubCommands
{
	private String name;
	public BankCommand(EpicSetClans plugin,EpicClanManager clanManager,ClanDuelManager duelManager)
	{
		...
		this.name = "bank";
		this.permission=plugin.isCommandOpen("bank");
	...
	public void onCommandByPlayer(Player sender, String[] sub) 
	{
		...
		placeHolders.put("%amount%", CommonUtils.getDecimalFormatted(clan.getClanBalance()));
