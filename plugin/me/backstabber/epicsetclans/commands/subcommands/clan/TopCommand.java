...
public class TopCommand extends SubCommands
{
	private String name;
	public TopCommand(EpicSetClans plugin,EpicClanManager clanManager,ClanDuelManager duelManager)
	{
	...
	public void onCommandByPlayer(Player sender, String[] sub) 
	{
		...
		sender.openInventory(plugin.getGuis().get("top").getMainInventory(null,sender));
	}
