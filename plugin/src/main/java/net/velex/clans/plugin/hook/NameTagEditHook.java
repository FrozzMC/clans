...
import net.velex.clans.api.event.ClanJoinEvent;
import net.velex.clans.api.event.ClanKickEvent;
import net.velex.clans.api.event.ClanLeaveEvent;
import net.velex.clans.api.event.ClanRenameEvent;
